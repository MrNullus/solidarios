...
require '../'.URL_BASE_CONTROLLERS.'alter_product.controller.php'; 
?>
...
<html lang="pt-br">
	<head>
		...
		<title>Alterar Imagem do Produto || Solidários</title>
	...
	<body>
		...
		<main id="corpo" class="page">
			...
			<center>
				...
				<form name="teste" action="<?php echo URL_BASE_CONTROLLERS; ?>alter_product.controller.php" method="post" enctype="multipart/form-data">
